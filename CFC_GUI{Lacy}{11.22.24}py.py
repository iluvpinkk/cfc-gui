...
# sauce module 
    ...
    def show_drink_choice(self):
        ...
        if drink_index:
            ...
            # THIS IS THE DUPLICATING ISSUE AREA
            order_id = insert_order(drink_name, drink_size, price)
            insert_order(drink_name, drink_size, price)
    ...
    def show_order(self):
        ...
        cursor.execute('SELECT id, item_name, item_type, price FROM orders')
